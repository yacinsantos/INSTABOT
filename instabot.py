...
class InstagramBot:
    ...
    def photo_likers(self, photo, limit):
        url_photo = "https://www.instagram.com/p/" + photo
        self.driver.get(url_photo)
        sleep(self.random_number_generator(2, 4))
        button = self.driver.find_elements_by_class_name('_8A5w5')[1]
        sleep(1)
        button.click()
...
if __name__ == "__main__":
    ...
    #bot.follow_users(bot.user_followers('ww3', limit=1000))

    #follow post likers
    bot.follow_users(bot.photo_likers("CAp0d-djEh_", 10))
